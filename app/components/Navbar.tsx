...
export default function Navbar({ title = "IPL CricBoard", showBack = false }: Props) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 w-full bg-[#1F4571] text-white shadow-lg border-b border-[#183a60]">
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link href="/" className="text-lg sm:text-xl font-semibold tracking-wide hover:opacity-80 transition-opacity">
            {title}
          </Link>
        </div>
